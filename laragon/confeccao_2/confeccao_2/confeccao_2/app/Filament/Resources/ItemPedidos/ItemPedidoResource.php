...
class ItemPedidoResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'Item Pedido';

    protected static ?string $navigationLabel = 'Itens de Pedido';
    protected static ?string $modelLabel = 'Item de Pedido';
    protected static ?string $pluralModelLabel = 'Itens de Pedido';
