...
<head>
    ...
    <title><?php echo e(config('app.name', 'MAINTSYS')); ?></title>
...
<nav>
    ...
    <div class="nav-links">
        ...
        <?php if(Route::has('login')): ?>
            <a href="<?php echo e(route('login')); ?>" class="btn-nav">Entrar</a>
        <?php endif; ?>
    </div>
</nav>
...
</html><?php /**PATH C:\laragon\www\doug\PBE\laragon\maintsys\maintsys\resources\views/welcome.blade.php ENDPATH**/ ?>