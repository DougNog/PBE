        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="mono" style="font-size:11px;color:var(--muted)">
                    <?php echo e($h->data_fim ? $h->data_fim->format('d/m/Y H:i') : '—'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\doug\PBE\laragon\maintsys\maintsys\resources\views/historico/index.blade.php ENDPATH**/ ?>