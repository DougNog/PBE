    ...
    <div class="dash-root">
        ...
        <div class="dash-hero">
            <div class="hero-inner">
                <div>
                    ...
                    <h1 class="hero-title">
                        Olá,<br><span><?php echo e(Auth::user()->name); ?></span> 👋
                    </h1>
        ...
        <div class="dash-body">
            ...
            <div class="nav-grid">
                ...
                <a href="<?php echo e(route('clientes.index')); ?>" class="nav-card clientes">
                ...
                <a href="<?php echo e(route('estoque.index')); ?>" class="nav-card estoque">
                    <div class="card-icon-wrap">📦</div>
                    <div class="card-body">
                ...
                <a href="<?php echo e(route('fornecedores.index')); ?>" class="nav-card fornecedores">
                    <div class="card-icon-wrap">🏭</div>
                    <div class="card-body">
                ...
                <a href="<?php echo e(route('pedidos.index')); ?>" class="nav-card pedidos">
                    <div class="card-icon-wrap">📋</div>
                    <div class="card-body">
            ...
            <div class="quick-grid">
                <a href="<?php echo e(route('clientes.create')); ?>" class="quick-card">
                    <div class="quick-icon">➕</div>
                    <span class="quick-label">Novo cliente</span>
                </a>

                <a href="<?php echo e(route('estoque.create')); ?>" class="quick-card">
                    <div class="quick-icon">📥</div>
                    <span class="quick-label">Novo item de estoque</span>
                </a>

                <a href="<?php echo e(route('fornecedores.create')); ?>" class="quick-card">
                    <div class="quick-icon">🏭</div>
                    <span class="quick-label">Novo fornecedor</span>
                </a>

                <a href="<?php echo e(route('pedidos.create')); ?>" class="quick-card">
                    <div class="quick-icon">📋</div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/dashboard.blade.php ENDPATH**/ ?>