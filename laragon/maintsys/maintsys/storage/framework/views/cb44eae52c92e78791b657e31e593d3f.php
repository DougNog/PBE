    ...
    <div class="clientes-root">
        ...
        <div class="page-hero">
            <div class="hero-inner">
                ...
                <a href="<?php echo e(route('clientes.create')); ?>" class="btn-new">
        ...
        <div class="page-body">
            ...
            <div class="stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(220px, 260px));">
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo e($clientes->total()); ?></div>
                </div>
            </div>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span class="table-badge" id="countBadge"><?php echo e($clientes->total() ?? $clientes->count()); ?> registros</span>
                </div>
                ...
                <?php if($clientes->isEmpty()): ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('clientes.create')); ?>" class="btn-empty">
                                    ...
                                    <tr>
                                        <td data-label="Cliente">
                                            <div class="client-cell">
                                                <div class="avatar">
                                                    <?php echo e(strtoupper(substr($c->nome, 0, 1))); ?><?php echo e(strtoupper(substr(strstr($c->nome, ' '), 1, 1))); ?>

                                                </div>
                                                <div>
                                                    <div class="td-nome"><?php echo e($c->nome); ?></div>
                                                    <div class="td-id">#<?php echo e($c->id); ?></div>
                                                </div>
                                            </div>
                                        </td>

                                        <td data-label="CPF">
                                            <span class="td-doc"><?php echo e($c->cpf ?? '—'); ?></span>
                                        </td>

                                        <td data-label="Telefone">
                                            <span class="td-telefone"><?php echo e($c->telefone ?? '—'); ?></span>
                                        </td>

                                        <td data-label="Ações" class="td-actions">
                                            <div class="actions-wrap">
                                                <a href="<?php echo e(route('clientes.show', $c->id)); ?>" class="btn-view">
                                                ...
                                                <a href="<?php echo e(route('clientes.edit', $c->id)); ?>" class="btn-edit">
                                                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                                ...
                                                <form action="<?php echo e(route('clientes.destroy', $c->id)); ?>" method="POST"
                                                      onsubmit="return confirm('Excluir o cliente «<?php echo e($c->nome); ?>»?')">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/clientes/index.blade.php ENDPATH**/ ?>