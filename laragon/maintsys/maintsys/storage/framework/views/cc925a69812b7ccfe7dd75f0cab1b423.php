...
<?php $component->withAttributes([]); ?>
    ...
    <style>
        ...
        :root{--ink:#0a0a0f;--surface:#f5f4f0;--card:#fff;--muted:#888;--border:#e8e6e1;--accent:#5b4aff;--ar:91,74,255;--red:#ff4c4c;}
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .preview{background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:1rem 1.25rem;margin-top:1.5rem;display:flex;align-items:center;justify-content:space-between;font-size:.88rem;color:var(--muted);}
        .preview-total{font-family:'Syne',sans-serif;font-weight:800;font-size:1.3rem;color:var(--ink);}
    ...
    <div class="root">
        <div class="hero">
            <div class="hero-inner">
                <a href="<?php echo e(route('estoque.index')); ?>" class="btn-back">
                ...
                <div>
                    <div class="hero-title">Novo Item de Estoque</div>
                    <div class="hero-sub">Cadastre um novo produto no inventário.</div>
                </div>
            </div>
        </div>
        ...
        <div class="body">
            ...
            <form action="<?php echo e(route('estoque.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-head"><span class="dot"></span><span class="card-title">Dados do item</span></div>
                    <div class="card-body">
                        <div class="grid">
                            <div class="field">
                                <label>Nome do item <span>*</span></label>
                                <input type="text" name="nome" value="<?php echo e(old('nome')); ?>" placeholder="Ex: Estoque A" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="produto" value="<?php echo e(old('produto')); ?>" placeholder="Ex: Calças Jeans" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                ...
                                <input type="number" name="quantidade" id="quantidade" value="<?php echo e(old('quantidade', 0)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <label>Custo unitário (R$) <span>*</span></label>
                                <input type="number" name="custo" id="custo" value="<?php echo e(old('custo', '0.00')); ?>" min="0" step="0.01" required>
                                <?php $__errorArgs = ['custo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="field-error"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="preview">
                            ...
                            <span class="preview-total" id="totalPreview">R$ 0,00</span>
                        </div>
                    </div>
                    <div class="card-foot">
    ...
    <script>
        function updateTotal(){
            ...
            document.getElementById('totalPreview').textContent='R$ '+(q*c).toLocaleString('pt-BR',{minimumFractionDigits:2,maximumFractionDigits:2});
        }
        document.getElementById('quantidade').addEventListener('input',updateTotal);
        document.getElementById('custo').addEventListener('input',updateTotal);
        updateTotal();
    </script>
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/estoque/create.blade.php ENDPATH**/ ?>