    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-hero::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 60% 80% at 80% -10%, rgba(91,74,255,.45) 0%, transparent 65%),
                radial-gradient(ellipse 40% 60% at -5% 110%, rgba(255,107,53,.35) 0%, transparent 60%);
            pointer-events: none;
        }
        ...
        .btn-new {
            ...
            box-shadow: 0 0 0 0 rgba(91,74,255,0);
            white-space: nowrap;
        }
        ...
        .btn-new:hover {
            ...
            box-shadow: 0 12px 32px rgba(91,74,255,.45);
        }
        ...
        .stat-card:nth-child(1) .stat-icon { background: #ede9ff; }
        .stat-card:nth-child(2) .stat-icon { background: #d9fff3; }
        .stat-card:nth-child(3) .stat-icon { background: #fff0e9; }
    ...
    <div class="estoque-root">
        ...
        <div class="page-hero">
            <div class="hero-inner">
                <div>
                    <h1 class="hero-title">
                        Gestão de<br><span>Estoque</span>
                    </h1>
                    <p class="hero-sub">Visualize, gerencie e controle seus produtos em tempo real.</p>
                </div>

                <a href="<?php echo e(route('estoque.create')); ?>" class="btn-new">
        ...
        <div class="page-body">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo e($itens->count()); ?></div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon">🔢</div>
                    <div class="stat-label">Quantidade total</div>
                    <div class="stat-value"><?php echo e(number_format($itens->sum('quantidade'), 0, ',', '.')); ?></div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="font-size:1.8rem;">
                        R$&nbsp;<?php echo e(number_format($itens->sum(fn($item) => $item->quantidade * $item->custo), 2, ',', '.')); ?>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span class="table-badge"><?php echo e($itens->total() ?? $itens->count()); ?> registros</span>
                </div>

                <?php if($itens->isEmpty()): ?>
                    <div class="empty-state">
                        <div class="empty-icon">📦</div>
                        <div class="empty-title">Nenhum item no estoque</div>
                        <p class="empty-sub">Cadastre o primeiro item para começar a controlar seu inventário.</p>
                        <a href="<?php echo e(route('estoque.create')); ?>" class="btn-empty">
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td data-label="ID">
                                            <span class="td-id">#<?php echo e($i->id); ?></span>
                                        </td>

                                        <td data-label="Nome">
                                            <span class="td-nome"><?php echo e($i->nome); ?></span>
                                        </td>

                                        <td data-label="Produto">
                                            <span class="td-produto"><?php echo e($i->produto); ?></span>
                                        </td>

                                        <td data-label="Quantidade">
                                            <span class="qty-badge"><?php echo e($i->quantidade); ?></span>
                                        </td>

                                        <td data-label="Custo unitário">
                                            <span class="td-custo">R$ <?php echo e(number_format($i->custo, 2, ',', '.')); ?></span>
                                        </td>

                                        <td data-label="Total">
                                            <span class="td-total">R$ <?php echo e(number_format($i->quantidade * $i->custo, 2, ',', '.')); ?></span>
                                        </td>

                                        <td data-label="Ações" class="td-actions">
                                            <div class="actions-wrap">
                                                <a href="<?php echo e(route('estoque.edit', $i->id)); ?>" class="btn-edit">
                                                ...
                                                <form action="<?php echo e(route('estoque.destroy', $i->id)); ?>" method="POST"
                                                      onsubmit="return confirm('Excluir «<?php echo e($i->nome); ?>»?')">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/estoque/index.blade.php ENDPATH**/ ?>