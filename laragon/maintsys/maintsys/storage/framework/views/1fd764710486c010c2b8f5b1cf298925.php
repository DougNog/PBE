    ...
    <div class="root">
        <div class="hero">
            <div class="hero-inner">
                <div class="hero-left">
                    <a href="<?php echo e(route('clientes.index')); ?>" class="back">
                ...
                <a href="<?php echo e(route('clientes.edit', $cliente->id)); ?>" class="btn-hero">
        ...
        <div class="body">
            <div class="card">
                <div class="card-head">
                    <div class="avatar"><?php echo e(strtoupper(substr($cliente->nome,0,1))); ?><?php echo e(strtoupper(substr(strstr($cliente->nome,' ')?:'  ',1,1))); ?></div>
                    <div>
                        <div class="cname"><?php echo e($cliente->nome); ?></div>
                        <div class="cid">#<?php echo e($cliente->id); ?> · Cliente</div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="grid">
                        <div class="fi"><span class="fi-label">CPF</span><span class="fi-value <?php echo e(!$cliente->cpf?'empty':''); ?>"><?php echo e($cliente->cpf ?? 'Não informado'); ?></span></div>
                        <div class="fi"><span class="fi-label">Telefone</span><span class="fi-value <?php echo e(!$cliente->telefone?'empty':''); ?>"><?php echo e($cliente->telefone ?? 'Não informado'); ?></span></div>
                        <div class="fi"><span class="fi-label">Cadastrado em</span><span class="fi-value"><?php echo e(\Carbon\Carbon::parse($cliente->created_at)->format('d/m/Y \à\s H:i')); ?></span></div>
                        <div class="fi"><span class="fi-label">Atualizado em</span><span class="fi-value"><?php echo e($cliente->updated_at ? \Carbon\Carbon::parse($cliente->updated_at)->format('d/m/Y \à\s H:i') : '—'); ?></span></div>
                    </div>
                </div>
                <div class="card-foot">
                    <a href="<?php echo e(route('clientes.index')); ?>" class="btn-back">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
                        Voltar
                    </a>
                    <a href="<?php echo e(route('clientes.edit', $cliente->id)); ?>" class="btn-edit">
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/clientes/show.blade.php ENDPATH**/ ?>