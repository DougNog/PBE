        ...
        <div class="body">
            ...
            <form action="<?php echo e(route('clientes.update', $cliente->id)); ?>" method="POST">
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="icon">👥</div>
                        <div><div class="card-title">Editar dados do cliente</div><div class="card-sub">#<?php echo e($cliente->id); ?> · <?php echo e($cliente->nome); ?></div></div>
                    </div>
                    <div class="card-body">
                        <div class="fg">
                            <div class="field">
                                <label for="nome">Nome *</label>
                                <input type="text" id="nome" name="nome" value="<?php echo e(old('nome', $cliente->nome)); ?>" placeholder="Nome completo" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="fg c2">
                                <div class="field">
                                    ...
                                    <input type="text" id="cpf" name="cpf" value="<?php echo e(old('cpf', $cliente->cpf)); ?>" placeholder="000.000.000-00" maxlength="14" oninput="maskCpf(this)">
                                    <?php $__errorArgs = ['cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" id="telefone" name="telefone" value="<?php echo e(old('telefone', $cliente->telefone)); ?>" placeholder="(00) 00000-0000" maxlength="15" oninput="maskTel(this)">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-top:.75rem;">
                <form action="<?php echo e(route('clientes.destroy', $cliente->id)); ?>" method="POST" onsubmit="return confirm('Excluir <?php echo e($cliente->nome); ?>?')">
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/clientes/edit.blade.php ENDPATH**/ ?>