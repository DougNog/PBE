...
<?php $component->withAttributes([]); ?>
    ...
    <style>
        ...
        :root{--ink:#0a0a0f;--surface:#f5f4f0;--card:#fff;--muted:#888;--border:#e8e6e1;--accent:#0ea87e;--ar:14,168,126;--red:#ff4c4c;}
    ...
    <div class="root">
        <div class="hero">
            <div class="hero-inner">
                ...
                <div>
                    <div class="hero-title">Novo Cliente</div>
                    <div class="hero-sub">Preencha os dados para cadastrar um novo cliente.</div>
                </div>
            </div>
        </div>
        ...
        <div class="body">
            ...
            <form action="<?php echo e(route('clientes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-head"><span class="dot"></span><span class="card-title">Dados do cliente</span></div>
                    <div class="card-body">
                        <div class="grid">
                            <div class="field full">
                                <label>Nome completo <span>*</span></label>
                                <input type="text" name="nome" value="<?php echo e(old('nome')); ?>" placeholder="Ex: Maria Silva" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="cpf" id="cpf" value="<?php echo e(old('cpf')); ?>" placeholder="000.000.000-00" maxlength="14" required>
                                <?php $__errorArgs = ['cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-foot">
                        <a href="<?php echo e(route('clientes.index')); ?>" class="btn-cancel">Cancelar</a>
    ...
    <script>
        document.getElementById('cpf').addEventListener('input',function(e){let v=e.target.value.replace(/\D/g,'').slice(0,11);v=v.replace(/(\d{3})(\d)/,'$1.$2').replace(/(\d{3})(\d)/,'$1.$2').replace(/(\d{3})(\d{1,2})$/,'$1-$2');e.target.value=v;});
...
<?php endif; ?><?php /**PATH C:\laragon\www\confeccao\resources\views/clientes/create.blade.php ENDPATH**/ ?>