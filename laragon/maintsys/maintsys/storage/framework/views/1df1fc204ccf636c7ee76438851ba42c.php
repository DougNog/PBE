...
<?php $__env->startSection('breadcrumb', '<span>ordens de serviço</span>'); ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php $sc = match($os->status){'aberta'=>'blue','em_andamento'=>'yellow','concluida'=>'green',default=>'gray'}; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\maintsys\resources\views/ordens/index.blade.php ENDPATH**/ ?>