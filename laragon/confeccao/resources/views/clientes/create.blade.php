                    ...
                    <div class="card-body">
                        <div class="grid">
                            <div class="field full">
                                ...
                                <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex: Maria Silva" required>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="telefone" id="telefone" value="{{ old('telefone') }}" placeholder="(00) 00000-0000" maxlength="15">
