                    ...
                    <div class="card-body">
                        <div class="grid">
                            <div class="field full">
                                ...
                                <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex: Confecções ABC Ltda" required>
                                @error('nome')<span class="field-error">{{ $message }}</span>@enderror
                            </div>
                            <div class="field">
                                <label>CNPJ</label>
                                <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj') }}" placeholder="00.000.000/0000-00" maxlength="18">
