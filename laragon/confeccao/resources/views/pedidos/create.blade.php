                    ...
                    <div class="card-body">
                        <div class="grid">
                            <div class="field">
                                ...
                                <input type="text" name="numero" value="{{ old('numero') }}" placeholder="Ex: 001" required>
                            ...
                            <div class="field">
                                ...
                                @error('data')<span class="field-error">{{ $message }}</span>@enderror
                            </div>
                            ...
                            <div class="field full">
                                ...
                                <textarea name="observacao" placeholder="Alguma observação sobre o pedido...">{{ old('observacao') }}</textarea>
