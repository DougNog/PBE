    ...
    <div class="estoque-root">
        ...
        <div class="page-hero">
            <div class="hero-inner">
                ...
                <a href="{{ route('estoque.create') }}" class="btn-new">
        ...
        <div class="page-body">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $itens->count() }}</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon">🔢</div>
                    <div class="stat-label">Quantidade total</div>
                    <div class="stat-value">{{ number_format($itens->sum('quantidade'), 0, ',', '.') }}</div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="font-size:1.8rem;">
                        R$&nbsp;{{ number_format($itens->sum(fn($item) => $item->quantidade * $item->custo), 2, ',', '.') }}
                    </div>
                </div>
            </div>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span class="table-badge">{{ $itens->total() ?? $itens->count() }} registros</span>
                </div>
                ...
                @if($itens->isEmpty())
                    <div class="empty-state">
                        ...
                        <a href="{{ route('estoque.create') }}" class="btn-empty">
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                @foreach($itens as $i)
                                    <tr>
                                        <td data-label="ID">
                                            <span class="td-id">#{{ $i->id }}</span>
                                        </td>

                                        <td data-label="Nome">
                                            <span class="td-nome">{{ $i->nome }}</span>
                                        </td>

                                        <td data-label="Produto">
                                            <span class="td-produto">{{ $i->produto }}</span>
                                        </td>

                                        <td data-label="Quantidade">
                                            <span class="qty-badge">{{ $i->quantidade }}</span>
                                        </td>

                                        <td data-label="Custo unitário">
                                            <span class="td-custo">R$ {{ number_format($i->custo, 2, ',', '.') }}</span>
                                        </td>

                                        <td data-label="Total">
                                            <span class="td-total">R$ {{ number_format($i->quantidade * $i->custo, 2, ',', '.') }}</span>
                                        </td>

                                        <td data-label="Ações" class="td-actions">
                                            <div class="actions-wrap">
                                                <a href="{{ route('estoque.edit', $i->id) }}" class="btn-edit">
                                                ...
                                                <form action="{{ route('estoque.destroy', $i->id) }}" method="POST"
                                                      onsubmit="return confirm('Excluir «{{ $i->nome }}»?')">
                                                    @csrf
                                                    @method('DELETE')
