    ...
    <div class="pedidos-root">
        ...
        <div class="page-hero">
            <div class="hero-inner">
                ...
                <a href="{{ route('pedidos.create') }}" class="btn-new">
        ...
        <div class="page-body">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $pedidos->total() ?? $pedidos->count() }}</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon">⏳</div>
                    <div class="stat-label">Pendentes</div>
                    <div class="stat-value">{{ $pedidos->where('status', 'pendente')->count() }}</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon">✅</div>
                    <div class="stat-label">Aprovados</div>
                    <div class="stat-value">{{ $pedidos->where('status', 'aprovado')->count() }}</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon">🚚</div>
                    <div class="stat-label">Entregues</div>
                    <div class="stat-value">{{ $pedidos->where('status', 'entregue')->count() }}</div>
                </div>
            </div>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span class="table-badge" id="countBadge">
                        {{ $pedidos->total() ?? $pedidos->count() }} registros
                    </span>
                </div>
                ...
                @if($pedidos->isEmpty())
                    <div class="empty-state">
                        ...
                        <a href="{{ route('pedidos.create') }}" class="btn-empty">
                                ...
                                @foreach($pedidos as $p)
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Observação">
                                            <span class="td-obs">{{ $p->observacao ?? '—' }}</span>
                                        </td>

                                        <td data-label="Ações" class="td-actions">
                                            <div class="actions-wrap">
                                                <a href="{{ route('pedidos.edit', $p->id) }}" class="btn-edit">
                                                ...
                                                <form action="{{ route('pedidos.destroy', $p->id) }}" method="POST"
                                                      onsubmit="return confirm('Excluir o pedido #{{ $p->numero }}?')">
                                                    @csrf
                                                    @method('DELETE')
