        ...
        <div class="page-body">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $fornecedores->total() ?? $fornecedores->count() }}</div>
                </div>
            </div>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span class="table-badge" id="countBadge">
                        {{ $fornecedores->total() ?? $fornecedores->count() }} registros
                    </span>
                </div>
                ...
                @if($fornecedores->isEmpty())
                    <div class="empty-state">
                        ...
                        <a href="{{ route('fornecedores.create') }}" class="btn-empty">
                                    ...
                                    <tr>
                                        <td data-label="Fornecedor">
                                            <div class="supplier-cell">
                                                <div class="avatar">
                                                    {{ strtoupper(substr($f->nome, 0, 1)) }}{{ strtoupper(substr(strstr($f->nome, ' ') ?: ' ', 1, 1)) }}
                                                </div>
                                                <div>
                                                    <div class="td-nome">{{ $f->nome }}</div>
                                                    <div class="td-id">#{{ $f->id }}</div>
                                                </div>
                                            </div>
                                        </td>

                                        <td data-label="CNPJ">
                                            <span class="td-info">{{ $f->cnpj ?? '—' }}</span>
                                        </td>

                                        <td data-label="Telefone">
                                            <span class="td-info">{{ $f->telefone ?? '—' }}</span>
                                        </td>

                                        <td data-label="E-mail">
                                            <span class="td-info">{{ $f->email ?? '—' }}</span>
                                        </td>

                                        <td data-label="Ações" class="td-actions">
                                            <div class="actions-wrap">
                                                <a href="{{ route('fornecedores.edit', $f->id) }}" class="btn-edit">
                                                ...
                                                <form action="{{ route('fornecedores.destroy', $f->id) }}" method="POST"
                                                      onsubmit="return confirm('Excluir o fornecedor «{{ $f->nome }}»?')">
                                                    @csrf
                                                    @method('DELETE')
